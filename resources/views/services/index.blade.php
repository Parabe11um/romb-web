                ...
                <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-60px] xxl:!px-5 !text-center items-end">
                    <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[60px]">
                        <div class="md:!px-20 lg:!px-3 xl:!px-3">
                            <figure class="!mb-6"><img class="img-auto" src="http://localhost/images/web.png" srcset="http://localhost/images/web.png 2x" alt="image"></figure>
                    ...
                    <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[60px]">
                        <div class="md:!px-20 lg:!px-3 xl:!px-3">
                            <figure class="!mb-6"><img class="img-auto" src="http://localhost/images/tech.png" srcset="http://localhost/images/tech.png 2x" alt="image"></figure>
                    ...
                    <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[60px]">
                        <div class="md:!px-20 lg:!px-3 xl:!px-3">
                            <figure class="!mb-6"><img class="img-auto" src="http://localhost/images/seo.png" srcset="http://localhost/images/seo.png 2x" alt="image"></figure>
