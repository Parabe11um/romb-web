<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="mb-12 text-center">
            <h2 class="text-3xl font-semibold mb-3">Статьи</h2>
            <p class="text-gray-500">Последние публикации</p>
        </div>

        @foreach($articles as $article)
            <article
                class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto]
