    ...
    <div class="container pt-6 pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24">
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px]">
            <div
                ...
                <h2 class="!text-[0.8rem] uppercase !text-[#5eb9f0] !leading-[1.35] !tracking-[0.02rem]  !mb-4">
                    FAQ</h2>
                <h3 class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-4">If you don't see
                    an answer to your question, you can send us an email from our contact form.</h3>
